...
LANGUAGES = {
    'portugues': {
        ...
        'register_entry_btn': 'Registrar Apontamento Final',
        ...
        'stop_label': 'Parada',
        'other_motives_label': 'Outro Motivo (Especifique)',
        ...
        'col_wo': 'WO', 'col_cliente': 'Cliente', 'col_qtde_cores': 'Qtd. Cores',
        'col_tipo_papel': 'Tipo de Papel', 'col_numeroinspecao': 'Nº de Inspeção', 'col_gramatura': 'Gramatura',
        'col_formato': 'Formato', 'col_fsc': 'FSC', 'col_tiragem_em_folhas': 'Tiragem (Folhas)',
        'col_giros_rodados': 'Giros Rodados', 'col_perdas_malas': 'Perdas (Acerto)', 'col_total_lavagens': 'Total Lavagens',
        'col_total_acertos': 'Total Acertos', 'col_ocorrencias': 'Ocorrências',
        'col_motivos_parada': 'Motivo da Parada', 'col_quantidadeproduzida': 'Qtd. Produzida',
        ...
        'giros_previstos': 'Giros Previstos',
        ...
        'save_order_error_details': 'Detalhes: {error}',
        ...
        'finished': 'CONCLUÍDO',
        'menu_manage_equipment': 'Gerenciar Equipamentos',
        'equipment_manager_title': 'Gerenciamento de Equipamentos',
        'equipment_types_section': 'Tipos de Equipamento',
        'dynamic_fields_section': 'Campos Dinâmicos',
        'col_field_name': 'Nome do Campo',
        'col_translation_key': 'Chave de Tradução',
        'col_data_type': 'Tipo de Dado',
        'col_widget_type': 'Tipo de Widget',
        'col_lookup_table': 'Tabela de Lookup',
        'field_association_section': 'Associação de Campos',
        'select_equipment_type': 'Selecionar Tipo de Equipamento',
        'available_fields': 'Campos Disponíveis',
        'assigned_fields': 'Campos Atribuídos',
        'select_field_to_assign': 'Selecione um campo para atribuir.',
        'select_equipment_type_first': 'Selecione um tipo de equipamento primeiro.',
        'success_title': 'Sucesso',
        'fields_assigned_success': 'Campos atribuídos com sucesso!',
        'select_field_to_unassign': 'Selecione um campo para desatribuir.',
        'fields_unassigned_success': 'Campos desatribuídos com sucesso!',
        'error_title': 'Erro',
        'warning_title': 'Aviso',
        'select_item_to_edit': 'Selecione um item para editar.',
        'select_item_to_delete': 'Selecione um item para excluir.',

        # New strings for SelectClosedWOWindow
        'select_closed_wo_title': 'Selecionar Ordem de Produção Encerrada',
        'search_label': 'Buscar',
        'closed_wo_list_label': 'Ordens Encerradas',
        'select_btn': 'Selecionar',
        'select_wo_msg': 'Por favor, selecione uma Ordem de Produção na lista.',
        'load_wo_error': 'Erro ao carregar Ordens de Produção encerradas',
                'copy_wo_btn': 'Copiar de W.O. Encerrada',
        'search_wo_pn_client_placeholder': 'Buscar por WO, PN ou Cliente',
    },
    'english': {
        'search_wo_pn_client_placeholder': 'Buscar por WO, PN ou Cliente',
    },
    'english': {
        ...
        # Success Messages
        'cancel_order_success': 'Production Order canceled successfully!',
        ...
        'invalid_status_for_action_msg': 'Action not allowed! Only orders with "Open" status can be edited or canceled.',
        ...
        'menu_manage_equipment': 'Manage Equipment',
        'equipment_manager_title': 'Equipment Management',
        'equipment_types_section': 'Equipment Types',
        'dynamic_fields_section': 'Dynamic Fields',
        'col_field_name': 'Field Name',
        'col_translation_key': 'Translation Key',
        'col_data_type': 'Data Type',
        'col_widget_type': 'Widget Type',
        'col_lookup_table': 'Lookup Table',
        'field_association_section': 'Field Association',
        'select_equipment_type': 'Select Equipment Type',
        'available_fields': 'Available Fields',
        'assigned_fields': 'Assigned Fields',
        'select_field_to_assign': 'Select a field to assign.',
        'select_equipment_type_first': 'Select an equipment type first.',
        'success_title': 'Success',
        'fields_assigned_success': 'Fields assigned successfully!',
        'select_field_to_unassign': 'Select a field to unassign.',
        'fields_unassigned_success': 'Fields unassigned successfully!',
        'error_title': 'Error',
        'warning_title': 'Aviso',
        'select_item_to_edit': 'Select an item to edit.',
        'select_item_to_delete': 'Select an item to delete.',
        'search_wo_pn_client_placeholder': 'Search by WO, PN or Client',
    },
}